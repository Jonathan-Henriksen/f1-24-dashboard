from enums import TyreCompounds, TyreCompoundsVisual
from packets import *
import json

class TyreInfoPanel():
    def __init__(self):
        self.title = "Tyre Info"
        self.tyre_compound = ""
        self.tyre_compound_visual = ""
        self.tyre_front_left = Tyre()
        self.tyre_front_right = Tyre()
        self.tyre_rear_left = Tyre()
        self.tyre_rear_right = Tyre()
        self.tyre_set_laps_age = 0
        self.tyre_set_laps_max = 0
        self.tyre_set_laps_remaining = 0

    def to_json(self):
        return json.dumps(self, default=lambda o: o.__dict__)
    
    def update_from_car_telemetry_packet(self, player_car_telemetry: CarTelemetry):
        ...
        self.tyre_front_right.temperature_brakes = player_car_telemetry.tyres_front_right_pressure
        self.tyre_front_right.pressure_psi = player_car_telemetry.brakes_front_right_temperature

        # Rear Left
        self.tyre_rear_left.temperature_brakes = player_car_telemetry.tyres_rear_left_temperature_surface
        self.tyre_rear_left.temperature_carcass = player_car_telemetry.tyres_rear_left_temperature_inner
        self.tyre_rear_left.temperature_surface = player_car_telemetry.tyres_rear_left_pressure
        self.tyre_rear_left.pressure_psi = player_car_telemetry.brakes_rear_left_temperature

        # Rear Right
        self.tyre_rear_right.temperature_brakes = player_car_telemetry.tyres_rear_right_temperature_surface      
        self.tyre_rear_right.temperature_carcass = player_car_telemetry.tyres_rear_right_temperature_inner
        self.tyre_rear_right.temperature_surface = player_car_telemetry.tyres_rear_right_pressure
        self.tyre_rear_right.pressure_psi = player_car_telemetry.brakes_rear_right_temperature
    ...
    def update_from_tyre_sets_packet(self, tyre_sets_packet: TyreSetsPacket):
        ...
        self.tyre_set_laps_max = fitted_tyre_set.num_of_laps_recommended

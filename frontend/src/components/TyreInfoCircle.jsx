...
const TyreData = ({ tyre, inverted }) => (
	<div className={`flex justify-center divide-x-2 gap-4 divide-mainWhite/50 ${inverted ? 'pl-4' : 'pr-4'}`}>
		...
		{/* Titles */}
		<div className="flex flex-col justify-start justify-items-center items-start">
		...
		{/* Values */}
		<div className="flex flex-col justify-start justify-items-start items-start pl-4">

...
const ColorLegend = ({ tyreCompound }) => (
	<div className="flex flex-col justify-start items-center gap-1 divide-y-2 justify-self-start divide-mainWhite/50">
		<span className="text-center text-xl font-bold">{tyreCompound}</span>
